...
console.log(dbInfo)
const groupomaniaDBConnect = mysql.createConnection(dbInfo);
...
exports.signUp = (req, res, next) => {
    ...
    bcrypt.hash(req.body.password, 10)
        .then((hash) => {
            ...
            const sqlCreateUser = `INSERT INTO users (firstName, lastName, email, password, isAdmin,createdAt,updatedAt) VALUES (?, ?, ?, ?, ?, now(),now())`;
